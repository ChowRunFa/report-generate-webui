...
<el-card v-if="paginatedContent.length > 0" style="margin-bottom: 20px;">
  <div class="demo-pagination-block">
    <div v-for="content in paginatedContent" class="report-output" v-html="content"></div>
    <el-pagination
...
import { paper_report, set_llm } from '@/apis/report/paper'
