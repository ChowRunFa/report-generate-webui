...
# set LLM path
MODEL_PATH = os.environ.get('MODEL_PATH', "E:\LargeFiles\Models\chatglm3-6b")
TOKENIZER_PATH = os.environ.get("TOKENIZER_PATH", "E:\LargeFiles\Models\chatglm3-6b")

# set Embedding Model path
EMBEDDING_PATH = os.environ.get('EMBEDDING_PATH', r'E:\LargeFiles\Models\bge-m3')
...
if __name__ == "__main__":
    ...
    # model = AutoModel.from_pretrained("E:\LargeFiles\Models\chatglm3-6b", trust_remote_code=True).cuda()
