...
if __name__ == '__main__':
    file_content, page_one  = read_and_clean_pdf_text("D:\毕业设计\参考文献\Automatic-Summarization\ChatCiteLLM Agent with Human Workflow Guidance for Comparative Literature Summary.pdf")
    for chunk in split_text_to_satisfy_token_limit(file_content, limit=2500):
        print(chunk)